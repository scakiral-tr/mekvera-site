export function Logo({ compact = false }: { compact?: boolean }) {
  return (
    <div className="brand" aria-label="MEKVERA Mimarlık Tasarım Uygulama">
      ...
      {!compact && <div><div className="brand-name">MEKVERA</div><div className="brand-sub">MİMARLIK • TASARIM • UYGULAMA</div></div>}
    </div>
  )
}
